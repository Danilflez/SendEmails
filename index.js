...
async function sendEmails() {
    ...
    <div style="background-image: url('cid:bg'); background-size: cover; background-position: center; width: 100%; height: 300px; margin-bottom: 20px;">
    </div>
    <div style="margin: 20px;">
        <h1 style="margin-top: 20px;">Здравствуйте!</h1>
        <p style="font-size: 16px; margin-bottom: 20px;">
            Мы разработали тех. поддержку с ИИ, и думаем что вам будет это интересно
        </p>
        <p style="font-size: 16px; margin-bottom: 20px;">
           Посмотрите презентацию о нашем продукте, и мы гарантируем повышение лояльности ваших клиентов
        </p>
    </div>
     <div style="text-align: center; margin-bottom: 20px;">
        <a href="https://lightning-support.netlify.app" style="display: inline-block; padding: 15px 60px; color: #CC65E8; border: 1px solid #CC65E8; text-decoration: none; border-radius: 10px; font-size: 16px;">
            Перейти на сайт
        </a>
    </div>
    <div style="text-align: center; margin-bottom: 20px;">
